                ...
                <div class="tab-content">
                    <div id="main" class="tab-pane active">
                        <form action="/admin/content/store/{{$item->id}}/main" class="form-horizontal form-bordered" method="post">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="inputDefault">{!! trans('admin.categories') !!}</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="inputDefault">{!! trans('admin.meta_description') !!}</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="inputDefault">{!! trans('admin.meta_keyword') !!}</label>
                                <div class="col-md-10">
