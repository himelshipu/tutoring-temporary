                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-details">
                    ...
                    @foreach($lists as $item)
                        ...
                        <tr>
                            ...
                            <td class="text-center" title="{{ optional($item->user)->username }}"><a href="/admin/user/item/{{ optional($item->user)->id }}">{{ optional($item->user)->name }}</a></td>
                            <td class="text-center">{{ $item->sells_count ?? '0' }}</td>
                            <td class="text-center">{{ $item->partsactive_count ?? '0' }}</td>
                            <td class="text-center">{{ $item->transactions->sum('price') }}<br>{{ currencySign() }}</td>
                            ...
                            <td class="text-center">
                                <a href="/admin/notification/new?recipent_type=userone&uid={{ optional($item->user)->id }}" title="Send notification to user"><i class="fa fa-bell-o" aria-hidden="true"></i></a>
                                <a href="/admin/ticket/new?uid={{ optional($item->user)->id }}&title=Course {{ $item->title }}" title="Send support ticket to user"><i class="fa fa-life-ring" aria-hidden="true"></i></a>
