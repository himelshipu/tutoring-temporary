                    ...
                    @foreach($lists as $index=>$item)
                        <tr>
                            ...
                            <td class="text-center"><a target="_blank"
                                                       href="/product/{!! $item->content->id  !!}">{!! $item->content->title ?? '' !!}</a>
                            </td>
                            ...
                            <td class="text-center">
                                <a href="/admin/live/details/{{ $item->id }}" title="Edit"><i class="fa fa-info-circle"
                                                                                              aria-hidden="true"></i></a>
                                <a href="#" data-href="/admin/live/delete/{{ $item->id }}" title="Delete"
