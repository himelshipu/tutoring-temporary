                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form method="POST" action="{{ route('admin.logout') }}">
                            @csrf
                            <a href="javascript:void(0);" class="dropdown-item has-icon text-danger" onclick="event.preventDefault();
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    @if(checkAccess('report'))
                    <li class="dropdown {{ (request()->is('admin/career-jobs*') ? 'active' : '') }}" id="messages">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-life-ring"></i> <span>Jobs</span></a>
                        <ul class="dropdown-menu">
                            <li class="{{ (request()->is('admin/career-jobs') ? 'active' : '') }}"><a class="nav-link" href="{{ route('career-jobs.index') }}">List</a></li>
                            <li class="{{ (request()->is('admin/career-jobs/create*') ? 'active' : '') }}"><a class="nav-link" href="{{ route('career-jobs.create') }}">New</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    @if(checkAccess('user'))
                        <li class="dropdown {{ (request()->is('admin/connections*') ? 'active' : '') }}" id="messages">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-life-ring"></i> <span>Connection</span></a>
                            <ul class="dropdown-menu">
                                <li class="{{ (request()->is('admin/connections/talent-acquisitions*') ? 'active' : '') }}"><a class="nav-link" href="{{route('talent-acquisitions.index')}}">Talent Acquisition</a></li>
                                <li class="{{ (request()->is('admin/connections/contact-us*') ? 'active' : '') }}"><a class="nav-link" href="{{route('contact-us.index')}}">Contact Messages</a></li>

                                <li class="{{ (request()->is('admin/connections/subscribers*') ? 'active' : '') }}"><a class="nav-link" href="{{route('subscribers.index')}}">Subscribers</a></li>
                            </ul>
                        </li>
                    @endif
...
{{--                                <li><a class="nav-link" href="/admin/setting/view_templates">{{  trans('admin.view_templates') }}</a></li>--}}
                    ...
                    <li>
                        <a href="/admin/logout" class="nav-link"><i class="fas fa-sign-out-alt"></i> <span>Log Out</span></a>
                    </li>
                </ul>
            </aside>
        </div>
