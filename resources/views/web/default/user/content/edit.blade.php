                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 tab-con">
                                        <select name="content_type" class="form-control font-s">
                                            <option value="mp4" @if(isset($item) && $item->content_type == 'mp4') selected @endif>Mp4</option>
                                            <option value="captivate" @if(isset($item) && $item->content_type == 'captivate') selected @endif>Adobe Captivate Zip</option>
                                        </select>
                                    </div>
                                </div>
                            @endif
...
<!--                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label tab-con col-md-2 label-video-file">{{ trans('main.video_file') }}</label>
                                                <div class="col-md-7 tab-con">
                                                    <div class="input-group asdf">
                                                        @if($item->content_type != 'captivate')<span class="input-group-addon view-selected img-icon-s" data-toggle="modal" data-target="#VideoModal" data-whatever="upload_video"><span class="formicon mdi mdi-eye"></span></span>@endif
...
<!--                                                        @if($item->content_type != 'captivate')<span data-toggle="modal" href="#vimeo-modal"
                                                ...
                                                <div class="col-md-2 tab-con">
                                                    <input name="sort" type="number" class="spinner-input form-control"  required maxlength="3" min="0" max="100">
                                                </div>
                                            </div>
                                ...
                                <li class="open">
                                    ...
                                    <div class="submenu dblock">
                                        ...
                                        <form action="/user/content/part/store" id="step-5-form-new-part" method="post" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2 tab-con">@if($item->content_type != 'captivate'){{ trans('main.video_file') }}@else Captivate Zip File @endif</label>
                                                <div class="col-md-7 tab-con">
                                                    <style>
                                                        .asdf {
                                                            display: flex;
                                                    ...
                                                    <div class="input-group asdf">
                                                        @if($item->content_type != 'captivate')<span class="input-group-addon view-selected img-icon-s" data-toggle="modal" data-target="#VideoModal" data-whatever="upload_video2"><span class="formicon mdi mdi-eye"></span></span>@endif
    ...
    <script>
        $('body').on('click', 'span.i-part-edit', function () {
            ...
            $.get('/user/content/part/edit/' + id, function (data) {
                ...
                $(efrom + 'select[name="server"]').val(data.server).trigger('change');
    ...
    <script>
        $(function (){
           $('.server').on('change', function (){
              let server = $(this).val();
              console.log(server);
              if(server == 'youtube' || server == 'vimeo'){
                  $(this).parent().parents().next().find('.input-group-addon').hide();
                  $(this).parent().parents().next().find('.click-for-vimeo').hide();
                  $(this).parent().parents().next().find('#lfm_upload_video').hide();
              }else{
                  $(this).parent().parents().next().find('.input-group-addon').show();
                  $(this).parent().parents().next().find('.click-for-vimeo').show();
                  $(this).parent().parents().next().find('#lfm_upload_video').show();
              }
           });
        });
    </script>
