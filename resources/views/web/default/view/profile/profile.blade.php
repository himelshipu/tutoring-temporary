    ...
    <div class="container-fluid profile-middle-background">
        <div class="container">
            ...
            <div class="location-section col-md-10 col-xs-12">
                ...
                <div class="profile_register_date_item"><b>Total Sell : {{ $total_course_sell }}</b></div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th>Certification  starts</th>
                                        <th>Certification  ends</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>{!! $training->training_institute ?? 'N/A' !!}</td>
                                        <td>{!! $training->training_starts ?? 'N/A' !!}</td>
                                        <td>{!! $training->training_ends ?? 'N/A' !!}</td>
                                        <td>{!! $training->training_description ?? 'N/A' !!}</td>
                                    </tr>
                                    @empty
                                ...
                                <table class="table">
                                    ...
                                    @forelse(json_decode($meta['projects']) as $project)
                                        <tr>
                                            ...
                                            <td>{!! $project->project_starts ?? 'N/A' !!}</td>
                                            <td>{!! $project->project_ends ?? 'N/A' !!}</td>
                                            <td>{!! $project->project_goal ?? 'N/A' !!}</td>
                            ...
                            @foreach($channels as $channel)
                                <div class="col-md-3 col-sm-6 col-xs-12 tab-con">
                                    <a href="/chanel/{{ $channel->username }}" title="{{ $channel->title }}" class="content-box">
                                        <img alt="{{ $channel->title ?? '' }}" src="{{ $channel->avatar }}"/>
