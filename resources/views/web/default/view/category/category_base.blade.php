                                ...
                                @if(!in_array($content['id'],$vipIds))
                                    <div class="col-md-3 col-sm-6 col-xs-12 pagi-content tab-con">
                                        <a href="/product/{{ $content['id'] }}/{!! \Illuminate\Support\Str::slug($content['title']) ?? '' !!}" title="{{ $content['title'] }}" class="content-box pagi-content-box">
                                            ...
                                            <div class="footer">
                                                <span class="avatar" title="{{ !empty($content['user']['name']) ? $content['user']['name'] : '' }}" onclick="window.location.href = '/profile/{{ $content['user']['id'] ?? null }}'"><img src="{{ get_user_meta($content['user_id'],'avatar',get_option('default_user_avatar','')) }}"></span>
