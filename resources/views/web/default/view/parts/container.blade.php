                    ...
                    @if(isset($slide->content->metas))
                        ...
                        <div class="parts-container-slide" id="slide{{ $slide->content->id }}">
                            ...
                            <div class="body-container">
                                <div class="row">
                                    <div class="col-md-7">
                                        <img src="{{ !empty($slide_meta['cover']) ? $slide_meta['cover'] : '' }}" alt="{!! $slide->content->title ?? '' !!}" class="img-responsive img-main-container img-con-r">
                                    </div>
                                    <div class="col-md-5 img-con-s">
                                        ...
                                        <div class="item-container">
                                            <div class="col-md-10 timer-item">
                                                <label>{{ contentDuration($slide->content->id) }}</label>
                                            </div>
                                            <div class="col-md-2 ">
