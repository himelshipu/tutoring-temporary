...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        ########################
        ## Connection Messages & Subscribers##
        ########################

        Route::resource('career-jobs', 'CareerJobController')->except([
          'destroy'
        ]);

        Route::get('career-jobs/{career_job}/delete', 'CareerJobController@destroy')->name('career-jobs.destroy');


        Route::group(['prefix' => 'connections'], function () {
            Route::get('subscribers', 'SubscriptionController@index')->name('subscribers.index');
            Route::get('subscribers/{subscriber}', 'SubscriptionController@destroy')->name('subscribers.destroy');


            Route::get('talent-acquisitions', 'TalentAcquisitionController@index')->name('talent-acquisitions.index');
            Route::get('talent-acquisitions/{message}/show', 'TalentAcquisitionController@show')->name('talent-acquisitions.show');
            Route::get('talent-acquisitions/{message}', 'TalentAcquisitionController@destroy')->name('talent-acquisitions.destroy');

            Route::get('contact-us', 'ContactUsController@index')->name('contact-us.index');
            Route::get('contact-us/{contact_us}/show', 'ContactUsController@show')->name('contact-us.show');
            Route::get('contact-us/{contact_us}', 'ContactUsController@destroy')->name('contact-us.destroy');



            // Route::get('contact-us-messages', 'ConnectionController@contactMessages')->name('admin-contact-us');
            Route::post('contact-us-messages-reply', 'ConnectionController@contactMessages')->name('contact-us-reply');
            Route::post('talent-acquisition-messages-reply', 'ConnectionController@contactMessages')->name('talent-acquisition-reply');
        });
        ...
        Route::group(['prefix' => 'quizzes'], function () {
            ...
            Route::get('/{quiz_id}/results', 'AdminController@QuizResults')->name('results.show');
            Route::get('/{quiz_id}/results/excel', 'AdminController@QuizResultsExcel');
            Route::get('/{quiz_id}/results/{result_id}/delete', 'AdminController@QuizResultsDelete')->name('result.delete');
        });
